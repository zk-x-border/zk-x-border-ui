...
const PayFormStep1: React.FC<PayFormStep1Props> = ({
  ...
  return (
    <div>
      <div className='relative flex flex-1 space-x-2 rounded-lg border border-gray-300 px-6 pb-6 pt-8'>
        <div className='absolute left-0 top-[-24px] text-sm text-white'>
          Sender
        </div>
        <select
          id='senderType'
      ...
      <div className='relative rounded-lg border border-gray-300 px-6 pb-6 pt-8'>
        <div className='absolute left-0 top-[-24px] text-sm text-white'>
          Receiver
        </div>
